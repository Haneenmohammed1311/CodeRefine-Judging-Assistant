...
| `GET /` | serves `web/index.html` | anyone this is what makes "one URL for the website and the API" work |
...
```
Then visit `http://localhost:8000` — that single address serves both the website and every endpoint above.
